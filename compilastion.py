...
def register():
    ...
    bpy.types.Scene.compilation_props = bpy.props.PointerProperty(type=CompilationProperties)
    bpy.types.Scene.body_list = bpy.props.CollectionProperty(type=BodyPropGroup)
    bpy.types.Scene.body_list_index = bpy.props.IntProperty()
    bpy.types.Scene.sequence_list = bpy.props.CollectionProperty(type=SequencePropGroup)
